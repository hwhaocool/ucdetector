...
REM java -jar %LAUNCHER% -application org.ucdetector.ucd -consolelog -data %WORKSPACE% -debug -ucd.projects org.ucdetector -ucd.options warnLimit=1,finalMethod=IGNORE
