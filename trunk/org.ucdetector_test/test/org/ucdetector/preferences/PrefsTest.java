...
public class PrefsTest extends TestCase {
        ...
        public static IPreferenceStore createStore(
            ...
            InvocationHandler handler = new InvocationHandler() {
                public Object invoke(Object proxy, Method method, Object[] args)
                    ...
                    throw new RuntimeException("Unhandeld method: "
                            + methodName);
                }
            };
            return (IPreferenceStore) Proxy.newProxyInstance(iPreferenceStore
                    .getClassLoader(), new Class[] { iPreferenceStore },
                    handler);
        }
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        IPreferenceStore store = StoreFactory
                .createStore(IPreferenceStore.class);
