...
rem java -jar %launcher% -application org.eclipse.ant.core.antRunner -data %workspace% -file headless.xml -consolelog -debug -projects org.ucdetector.example,org.ucdetector
